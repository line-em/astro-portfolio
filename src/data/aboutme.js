export default {
	...
	description: `I'm Aline, a <strong>Front-End developer</strong> building web applications and looking for a <strong>career change</strong>. With a background in art, design and a passion for responsive user interfaces, I bring a unique perspective to building web applications. I've honed my skills in React, Javascript, CSS and HTML, alongside other knowledge such as Git, Npm and others. I'm focused on delivering <strong>great user experiences and responsive websites.</strong> Let's work together!`
};
